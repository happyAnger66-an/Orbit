...
Set for the duration of :meth:`orbit.agents.runner.runner.AgentRunner._execute_agent_turn`
so :func:`orbit.agents.session.transcript._notify_transcript_index_delta` can target the
