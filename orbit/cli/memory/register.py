...
def register_memory_cli(program: click.Group, ctx: ProgramContext) -> None:
    ...
    @program.group(
        "memory",
        help="Search, inspect memory/bootstrap files (default workspace: ~/.orbit/agents/main/workspace; USER.md, MEMORY.md, etc.)",
    )
    @click.option(
        "--workspace",
        "workspace_dir",
        ...
        default=None,
        help="Workspace directory (default: ~/.orbit/agents/main/workspace)",
    )
    @click.pass_context
