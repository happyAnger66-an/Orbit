 ...
 * Locale is stored in localStorage (key: orbit-dashboard-locale).
 */

const STORAGE_KEY = "orbit-dashboard-locale";
...
const messages = {
  en: {
    ...
    activeRuns: "{n} active",
    configSubtitle: "Full orbit.json config (llm, tools, channels, skills, etc.).",
    refresh: "Refresh",
    save: "Save",
  ...
  "zh-CN": {
    ...
    activeRuns: "{n} 个活动运行",
    configSubtitle: "展示 orbit.json 的完整配置内容（llm、tools、channels、skills 等）。",
    refresh: "刷新",
    save: "保存",
    configCurrent: "当前分区",
    configAll: "全部",
