...
def register_dashboard_cli(program: click.Group, ctx: ProgramContext) -> None:
    ...
    @program.command("dashboard", help="Open the MW4Agent web dashboard in your browser")
    @click.option(
        "--url",
    ...
    def dashboard_cmd(click_ctx: click.Context, url: str, no_open: bool) -> None:
        ...
        if opened:
            click.echo("Opened in your default browser. Keep that tab to control MW4Agent.")
        else:
